...
{
    void PopulateVirusList(std::array<Virus, kNumViruses>& viruses, std::array<size_t, kNumSymptomsPerVirus>& symptoms, size_t virus_symptom_index, size_t symptom_list_index, size_t& virus_index)
    {
